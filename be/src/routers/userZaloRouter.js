...
router.get("/listRewardsByStoreId",authMiddleware,userZaloController.listRewardsByStoreId)
router.get("/listRewardIsGlobal",authMiddleware,userZaloController.listRewardIsGlobal)
...
router.get("/getAllStore",authMiddleware,userZaloController.getInfoNotificationUser)
