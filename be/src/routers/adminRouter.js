...
router.put("/updateUserZaloActive",authMiddleware,validateAdmin,adminController.updateUserZaloActive)
router.put("/updatePartnerActive",authMiddleware,validateAdmin,adminController.updatePartnerActive)
